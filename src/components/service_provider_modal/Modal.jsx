...
import { Avatar, Button, Dialog, DialogActions, DialogContent, DialogTitle, Grid, IconButton, Typography } from '@mui/material';
import React from 'react'
import CloseIcon from '@mui/icons-material/Close';
import PropTypes from 'prop-types';
import { styled } from '@mui/material/styles';
import Pic from '../../Media/images/prof avatar.png';
import { Circle, DisabledByDefaultOutlined, Download, Email, InsertInvitation, NewspaperOutlined, Phone, Today } from '@mui/icons-material';
import './modal.css'
                ...
                <DialogContent>
                    <div className='container my-2'>
                        <div className='d-flex justify-content-start'>
                            <div className='preq-icon-wrapper'>
                                <Avatar alt="wollace" src={Pic} sx={{ width: 50, height: 50 }} />
                            </div>
                  ...
                  <span style={{ fontSize: '15px', color: 'red' }}>NEW</span>
                                ...
                                <div className='mb-2'>
                                  ...
                                  <p>  highly  trained in  the  field  of  mechanics  and  the  field  of automotive engineering 
                                     </p>
                                     <p className='fs-15'> Skill 2.</p>
                                  <p>  highly  trained in  the  field  of  electricity  and  the  field  of automotive engineering 
                                     </p>
                                ...
                                <div className='mb-3'>
                                    ...
                                    <p className='fs-15'>1. First Aid CertificationAmerican Red Cross, July 2018Expires: January 2020Skills acquired: CPR</p>
                                   <p>
   2. Certified CPR sports teacher with 15+ years of experience and solid organizational skills, 
    seeking to preserve and improve the quality of sports education at Amigos Children's Academy. At Jefferson Elementary,
     raised sports team national results by 12% and led an exhibition team at the 2019 World Aquatics Championships.
      </p>
                                </div>
                            </div>
                        </div>
                ...
                <DialogActions sx={{ mx: 3, mb: 2 }}>
                    <Button
                        sx={{ textTransform: 'capitalize', position: 'absolute', left: '6.75rem' }}
                        // variant="outlined" 
                        color="inherit"
                        startIcon={<Download />}
                    >
